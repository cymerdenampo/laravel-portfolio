...
<header id="header">
    <div class="d-flex flex-column">
        ...
        <div class="profile">
            <img src="{{ asset('cymer/assets/img/cymer-profile.jpg') }}" alt=""
            ...
            <div class="social-links mt-3 text-center">
                ...
                <a href="https://github.com/cymerdenampo" class="instagram" target="_blank"><i class="bx bxl-github"></i></a>
                <a href="https://join.skype.com/invite/ssDqhnotNRat" class="google-plus" target="_blank"><i class="bx bxl-skype"></i></a>
                <a href="https://www.linkedin.com/in/cymer-denampo-384561280/" class="linkedin" target="_blank"><i class="bx bxl-linkedin"></i></a>
            </div>
        </div>
